...
#linking  these tables together and establish a fact table
#thereafter  joining  the dataframes on the common columns
'''create a unique for the product category dataframe,so that we can join it with the other dataframes'''
...
#Data Analysis(credict @peterAdekolu)
'''we then obtain top selling sellers
1. the most used payment type
2. the top loyal customers
3. the top selling product category
4. the order status count 
5. the average delivery time for each product category
6. the average payment value by payment type'''
