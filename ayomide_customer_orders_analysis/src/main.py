from processing import (load_data,check_missing_duplcates,transform_product_category_df,process_fact_table,analysis,load_to_duckdb)
...
from sqlalchemy.ext.declarative import declarative_base
from database import (Base,FactTable,Top_Selling_Sellers,Most_Used_Payment_Type,Top_Selling_Product_Category,Order_Status_Count,Top_Average_Delivery_Time,Average_Payment_Value,Loyal_Customers)
...
def main():
    ...
    load_to_duckdb(fact_table,db_path,FactTable,Base)
